...
document.querySelectorAll('.ourproject-content div').forEach(item => {
    item.addEventListener('click', event => {
        ...
        document.querySelectorAll('.ourproject-content div').forEach(div => div.classList.remove('active'));
        document.querySelectorAll('.ourproject-image-container img').forEach(img => img.classList.remove('active'));
